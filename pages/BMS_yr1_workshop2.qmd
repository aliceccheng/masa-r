...
# R workshop 2:<br>Descriptive statistics and graphing in R
...
### Steps for importing Excel data
...
Download the penguins.xlsx file from SurreyLearn [link] and save it in your dedicated folder for the R work on this module. This should be the same location as where your R script is saved.
...
**Step 6: Check the data has imported successfully**
...
::: {.callout-note icon="false" collapse="true"}
### [{{< fa info-circle >}}]{style="color: #9e9e9e;"}  Things to check if you're having issues importing data
...
We'll use some simple functions, some of which you may have seen in workshop 1, to explore the `penguins` dataset.
...
**Applying a statistical function to a data frame column - general template**
...
- In the `function` blank, enter the summary statistic you want to calculate. For example, mean, median, sd etc.
:::
...
Calculate the median body mass of each species (i.e. calculate the median body mass *grouped by* species)
...
- Use the by() function to find the minimum body mass of each species
- Use the by() function to find the maximum body mass of each species
...
We can build the boxplot one component at a time, shown in the code tabs below.

::: {.callout-caution icon="false"}
### [{{< fa laptop-code >}}]{style="color: #2E6B4E;"}  Task
- Click through the tabs below to see how each code component contributes to building up the boxplot step by step
:::
...
::: {.callout-caution icon="false"}
### [{{< fa laptop-code >}}]{style="color: #2E6B4E;"}  Task
- Copy the code from the final tab above to your script.
- Run the code to produce the boxplot.
:::

### Template code for a boxplot

Below is a template for creating a boxplot with any dataset you like. Remember that the variable on the y-axis should be a continuous variable, while the variable on the x-axis should be a categorical variable representing the groups being compared.
...
## Extension: additional boxplot task
...
In this workshop, we worked with a larger dataset imported from Excel and used it to compare body mass between different penguin species.

Below is a summary of the main concepts covered.

::: {.callout-tip icon="false" collapse="true"}
### [{{< fa regular lightbulb >}}]{style="color: #872046;"} Data import and exploration

- Use `read_excel()` to import Excel data into R.
- Use `names()`, `head()`, `View()`, and `str()` to explore a data frame.
- It is good practice to explore and understand a dataset before analysing it.
:::

::: {.callout-tip icon="false" collapse="true"}
### [{{< fa regular lightbulb >}}]{style="color: #872046;"} Factors and data types

- Factors are used to store categorical variables with fixed levels.
- Use `as.factor()` to convert a variable to a factor.
- Use `str()` to check the data types of variables in a data frame.
:::

::: {.callout-tip icon="false" collapse="true"}
### [{{< fa regular lightbulb >}}]{style="color: #872046;"} Descriptive statistics

- Use `summary()` and `describe()` to generate summaries of a data frame.
- Use functions such as `mean()`, `median()`, `sd()`, `min()`, and `max()` to calculate descriptive statistics.
- Use `table()` to count observations in categorical variables.
- Use `by()` to calculate descriptive statistics separately for different groups.
:::

::: {.callout-tip icon="false" collapse="true"}
### [{{< fa regular lightbulb >}}]{style="color: #872046;"} Boxplots

- Use the **ggplot2** package to create boxplots.
- Use `ggplot()` to specify the data and variables.
- Use `geom_boxplot()` to create a boxplot.
- In a boxplot, the x-axis should contain a categorical variable and the y-axis should contain a continuous numeric variable.
- Boxplots provide a visual way to compare groups.
:::

::: {.callout-tip icon="false" collapse="true"}
### [{{< fa regular lightbulb >}}]{style="color: #872046;"} Key workflow

1. Import the data.
2. Explore the data.
3. Check data types and convert variables to factors where appropriate.
4. Generate descriptive statistics.
5. Compare groups using tables, summary statistics, and boxplots.
:::

In the next and final workshop, we will revisit and practise these skills using a new dataset, and learn how to statistically test for differences between two groups.

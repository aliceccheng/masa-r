...
Copy and paste this line of code into your script (not including the `>` symbol).
...
| Function | Statistic Calculated | Example | Result |
|----------|---------------------|---------|--------|
...
Most of the functions in this table are designed for numeric variables, such as body mass, flipper length, or bill length. Applying these functions to character or factor variables will usually result in an error.
...
Many types of plot can be produced using ggplot2

Here we will focus on creating a box plot.
